 ...
 */
public class stjamesActivity extends Activity implements Button.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stjames);
        ...
        //set a camera
        CameraUpdate citycamera= CameraUpdateFactory.newLatLngZoom(campusList.getLOCATION_STJAMES(), 10);
        ...
        switch (id){
            ...
            case R.id.direction:
                ...
                Document doc = md.getDocument(new LatLng(myLocation.getLatitude(),myLocation.getLongitude()),
                        campusList.getLOCATION_STJAMES(), GMapV2Direction.MODE_DRIVING);

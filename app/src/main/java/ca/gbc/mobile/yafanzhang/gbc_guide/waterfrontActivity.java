 ...
 */
public class waterfrontActivity extends Activity implements Button.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set a camera
        CameraUpdate citycamera= CameraUpdateFactory.newLatLngZoom(campusList.getLOCATION_WATERFRONT(), 10);
        ...
        switch (id){
            ...
            case R.id.direction:
                ...
                Document doc = md.getDocument(new LatLng(myLocation.getLatitude(),myLocation.getLongitude()),
                        campusList.getLOCATION_WATERFRONT(), GMapV2Direction.MODE_DRIVING);
